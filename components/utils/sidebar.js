    ...
    return (
        <Link key={props.key} href={props.href}>
            <div className={props.current ? "flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-md mt-5" : "flex items-center px-4 py-2 mt-5 text-gray-200 transition-colors duration-300 transform rounded-md hover:bg-white hover:bg-opacity-30 hover:text-gray-700"}>
                <Image className="object-cover h-7 w-7 drop-shadow-sm" src={props.image} alt="nav link img" />
        ...
        <div className="flex flex-col w-64 h-screen px-4 py-8 border-r bg-teal-700">
            ...
            <div className="flex flex-col justify-between flex-1 mt-3">
                ...
                <div className="flex items-center px-4 -mx-2">
                    <Image className="object-cover mx-2 rounded-full h-9 w-9" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar" />
